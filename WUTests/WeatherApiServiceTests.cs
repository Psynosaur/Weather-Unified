...
namespace WUTests
{
    public class WeatherApiServiceTests
    {
        ...
        [Fact]
        public void WeatherApiService_CanBeInstantiated()
        {
            // Arrange
        ...
        [Fact]
        public void WeatherApiService_AllMethodsExist()
        {
            // Arrange
            var httpClient = new HttpClient();
            var service = new WeatherApiService(httpClient, _loggerMock.Object, _appSettingsMock.Object);
            ...
            Assert.NotNull(service.GetLatestObservationsAsync());
            Assert.NotNull(service.GetHourlyObservationsAsync(12));
            Assert.NotNull(service.GetDailyObservationsAsync());
            Assert.NotNull(service.GetWeeklyObservationsAsync());
            Assert.NotNull(service.GetMonthlyObservationsAsync());
            Assert.NotNull(service.GetObservationsByDateAsync("2023-01-01"));
            Assert.NotNull(service.GetRainDataAsync("2023-01-01", "2023-01-02"));
            Assert.NotNull(service.GetObservationCountAsync());
            Assert.NotNull(service.GetLatestForecastAsync());
        }
    }
}
